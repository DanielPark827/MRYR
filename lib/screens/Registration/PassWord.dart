...
import 'package:mryr/screens/Registration/Sex.dart';
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: TextField(
                      ...
                      onChanged: (text) {
                        data.ChangeUserPassword(text);
                        if(data.UserPassword != null && ConfirmedPassword != null && data.UserPassword == ConfirmedPassword) {
                          setState(() {
                            Complete = true;
                          });
                        } else {
