...
class TutorialForShort extends StatefulWidget {
  @override
  _TutorialForShortState createState() => _TutorialForShortState();
}

class _TutorialForShortState extends State<TutorialForShort> {
  int currentPage = 0;
  void initState() {
    super.initState();
