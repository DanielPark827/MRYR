...
class ReportScreen extends StatefulWidget {
  ...
  ReportScreen({Key key, this.roomSalesInfo,}) : super(key : key);
          ...
          bottomNavigationBar: GestureDetector(
            onTap: ()async{
              ...
              Function okFunc = () async {
                ...
                var res = await ApiProvider().post('/ReportWrite/ReportInsert',jsonEncode({
                  "fromID" : GlobalProfile.loggedInUser.userID,
                  "toID" : widget.roomSalesInfo.userID,
