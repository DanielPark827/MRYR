...
import '../../NewRoomScreen.dart';
import '../SearchMapForReview.dart';

class TutorialForReview extends StatefulWidget {
  @override
  _TutorialForReviewState createState() => _TutorialForReviewState();
}

class _TutorialForReviewState extends State<TutorialForReview> {
  int currentPage = 0;
  void initState() {
    super.initState();
