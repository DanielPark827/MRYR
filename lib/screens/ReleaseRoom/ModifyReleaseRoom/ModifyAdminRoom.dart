...
class ModifyAdminRoom extends StatefulWidget {
  RoomSalesInfo roomSalesInfo;

  ModifyAdminRoom({Key key, this.roomSalesInfo,}) : super(key : key);
  @override
  _ModifyAdminRoomState createState() => _ModifyAdminRoomState();
}


class _ModifyAdminRoomState extends State<ModifyAdminRoom> {
  String adressValue;
  ...
  void initState() {
    ...
    type = widget.roomSalesInfo.type;
    location = widget.roomSalesInfo.location;
    locationdetail = widget.roomSalesInfo.locationDetail;
    square = widget.roomSalesInfo.square;
    dailyrentfeesoffer = widget.roomSalesInfo.DailyRentFeesOffer;
    weeklyrentfeesoffer = widget.roomSalesInfo.WeeklyRentFeesOffer;
    monthlyrentfeesoffer = widget.roomSalesInfo.monthlyRentFeesOffer;
    rentstart = widget.roomSalesInfo.termOfLeaseMin;
    rentdone = widget.roomSalesInfo.termOfLeaseMax;
    OptionList = [ widget.roomSalesInfo.bed,
      widget.roomSalesInfo.desk,
      widget.roomSalesInfo.chair,
      widget.roomSalesInfo.closet,
      widget.roomSalesInfo.aircon,
      widget.roomSalesInfo.induction,
      widget.roomSalesInfo.refrigerator,
      widget.roomSalesInfo.tv,
      widget.roomSalesInfo.doorLock,
      widget.roomSalesInfo.microwave,
      widget.roomSalesInfo.washingMachine,
      widget.roomSalesInfo.hallwayCCTV,
      widget.roomSalesInfo.wifi,
      widget.roomSalesInfo.parking];
    bed =  widget.roomSalesInfo.bed;
    desk = widget.roomSalesInfo.desk;
    chair = widget.roomSalesInfo.chair;
    closet = widget.roomSalesInfo.closet;
    aircon = widget.roomSalesInfo.aircon;
    induction = widget.roomSalesInfo.induction;
    refrigerator = widget.roomSalesInfo.refrigerator;
    doorlock = widget.roomSalesInfo.doorLock;
    tv = widget.roomSalesInfo.tv;
    microwave = widget.roomSalesInfo.microwave;
    washingmachine =  widget.roomSalesInfo.washingMachine;
    hallwaycctv =  widget.roomSalesInfo.hallwayCCTV;
    wifi = widget.roomSalesInfo.wifi;
    parking = widget.roomSalesInfo.parking;
    if( widget.roomSalesInfo.information != null &&  widget.roomSalesInfo.information != "") {
      Description = TextEditingController(text:  widget.roomSalesInfo.information);
    }
    if( widget.roomSalesInfo.locationDetail != null &&  widget.roomSalesInfo.locationDetail != "") {
      addressController = TextEditingController(text:  widget.roomSalesInfo.locationDetail);
    }
    if( widget.roomSalesInfo.square != null &&  widget.roomSalesInfo.square.toString() != "") {
      areaController = TextEditingController(text:  widget.roomSalesInfo.square.toString());
    }
    if( widget.roomSalesInfo.DailyRentFeesOffer != null &&  widget.roomSalesInfo.DailyRentFeesOffer.toString() != "") {
      dayController = TextEditingController(text:  widget.roomSalesInfo.DailyRentFeesOffer.toString());
    }
    if( widget.roomSalesInfo.WeeklyRentFeesOffer != null &&  widget.roomSalesInfo.WeeklyRentFeesOffer.toString() != "") {
      weekController = TextEditingController(text:  widget.roomSalesInfo.WeeklyRentFeesOffer.toString());
    }
    if( widget.roomSalesInfo.monthlyRentFeesOffer != null &&  widget.roomSalesInfo.monthlyRentFeesOffer.toString() != "") {
      monthController = TextEditingController(text:  widget.roomSalesInfo.monthlyRentFeesOffer.toString());
    }
    information   = widget.roomSalesInfo.information;
    latitude = widget.roomSalesInfo.lat;
    longitude = widget.roomSalesInfo.lng;


    ()async{
      if(widget.roomSalesInfo.imageUrl1 != null){
        var response = await get(get_resize_image_name(widget.roomSalesInfo.imageUrl1,360));
      ...
      if(widget.roomSalesInfo.imageUrl2 != null) {
        var response = await get(get_resize_image_name(widget.roomSalesInfo.imageUrl2,360));
        var documentDirectory = await getApplicationDocumentsDirectory();
        var firstPath = documentDirectory.path + "/images";
      ...
      if(widget.roomSalesInfo.imageUrl3 != null) {
        var response = await get(get_resize_image_name(widget.roomSalesInfo.imageUrl3,360));
        var documentDirectory = await getApplicationDocumentsDirectory();
        var firstPath = documentDirectory.path + "/images";
      ...
      if(widget.roomSalesInfo.imageUrl4!= null) {
        var response = await get(get_resize_image_name(widget.roomSalesInfo.imageUrl4,360));
        var documentDirectory = await getApplicationDocumentsDirectory();
        var firstPath = documentDirectory.path + "/images";
      ...
      if(widget.roomSalesInfo.imageUrl5 != null) {
        var response = await get(get_resize_image_name(widget.roomSalesInfo.imageUrl5,360));
        var documentDirectory = await getApplicationDocumentsDirectory();
        var firstPath = documentDirectory.path + "/images";
          ...
          onTap: ()async{
            ...
            if( ItemImgList.length >= 3 ) {
              ...
              Future.microtask(() async {
                ...
                var res = await dio.post(ApiProvider().getUrl+"/RoomsalesInfo/ShortUpdate",  data: formData).timeout(const Duration(seconds: 17));
