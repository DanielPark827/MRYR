...
class _ModifyPriceState extends State<ModifyPrice> {
                      ...
                      data.transferType == 0 ?   Container(
                        ...
                        child: Checkbox(
                          ...
                          onChanged: (bool value) {
                            ...
                            // else if (null != suggestDeposit.text){
                            //   data.ChangeProposedDeposit(int.parse(suggestDeposit.text));
                            // }
                            setState(() {
                      ...
                      Container(
                        ...
                        child: Checkbox(
                          ...
                          onChanged: (bool value) {
                            ...
                            // else if (null != suggestDeposit.text) {
                            //   data.ChangeProposedMonthlyRent(int.parse(suggestMonthlyRent.text));
                            // }
                            setState(() {
  ...
  void CheckForProposePrice(EnterRoomInfoProvider data) {
    ...
    else if(!data.monthlyCheckBox && (data.ProposedMonthlyRent == null || data.ProposedMonthlyRent == -1)) {
      data.ChangeCheckComplete(false);
    }
    else {
