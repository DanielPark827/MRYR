...
class OtherSuggestion extends StatefulWidget {
  @override
  _OtherSuggestionState createState() => _OtherSuggestionState();
}

class _OtherSuggestionState extends State<OtherSuggestion> {
