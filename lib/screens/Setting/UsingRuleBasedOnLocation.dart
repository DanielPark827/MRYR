...
class UsingRuleBasedOnLocation extends StatefulWidget {
  @override
  _UsingRuleBasedOnLocationState createState() => _UsingRuleBasedOnLocationState();
}

class _UsingRuleBasedOnLocationState extends State<UsingRuleBasedOnLocation> {
  void initState() {
    super.initState();
