...
class TutorialShortInSetting extends StatefulWidget {
  @override
  _TutorialShortInSettingState createState() => _TutorialShortInSettingState();
}

class _TutorialShortInSettingState extends State<TutorialShortInSetting> {
  int currentPage = 0;
  void initState() {
    super.initState();
  ...
  List<Map<String, String>> splashData = [
    {
      'image': short1InAppTutorialScreen
    },
    {
      "image": short2InAppTutorialScreen
    },
    {
      "image": short3InAppTutorialScreen
    },
    {
