...
class TutorialLongInSetting extends StatefulWidget {
  @override
  _TutorialLongInSettingState createState() => _TutorialLongInSettingState();
}

class _TutorialLongInSettingState extends State<TutorialLongInSetting> {
  int currentPage = 0;
  void initState() {
    super.initState();
