...
class TutorialReviewInSetting extends StatefulWidget {
  @override
  _TutorialReviewInSettingState createState() => _TutorialReviewInSettingState();
}

class _TutorialReviewInSettingState extends State<TutorialReviewInSetting> {
  int currentPage = 0;
  void initState() {
    super.initState();
  ...
  List<Map<String, String>> splashData = [
    {
      'image': review1InAppTutorialScreen
    },
    {
      "image": review2InAppTutorialScreen
    },
    {
      "image": review3InAppTutorialScreen
    },
    {
                      ...
                      Center(
                        child: Container(
                          ...
                          child: FlatButton(onPressed: () async {
                            ...
                            child: Center(child: Text("돌아가기",style: TextStyle(fontSize: screenWidth*(16/360),fontWeight: FontWeight.bold,color: Colors.white),)),
                          )),
                        ),
                      )
